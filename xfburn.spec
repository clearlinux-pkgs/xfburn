...
Source0  : http://archive.xfce.org/src/apps/xfburn/0.6/xfburn-0.6.1.tar.bz2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1572879536
...
cp %{_builddir}/xfburn-0.6.1/COPYING %{buildroot}/usr/share/package-licenses/xfburn/dfac199a7539a404407098a2541b9482279f690d
%make_install
%find_lang xfburn
