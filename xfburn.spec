...
Source0  : https://archive.xfce.org/src/apps/xfburn/0.7/xfburn-0.7.0.tar.bz2
...
%prep
%setup -q -n xfburn-0.7.0
cd %{_builddir}/xfburn-0.7.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677981085
