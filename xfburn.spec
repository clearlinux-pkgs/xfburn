...
Version  : 0.7.2
Release  : 13
URL      : https://archive.xfce.org/src/apps/xfburn/0.7/xfburn-0.7.2.tar.bz2
Source0  : https://archive.xfce.org/src/apps/xfburn/0.7/xfburn-0.7.2.tar.bz2
...
%prep
%setup -q -n xfburn-0.7.2
cd %{_builddir}/xfburn-0.7.2
pushd ..
cp -a xfburn-0.7.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723561399
